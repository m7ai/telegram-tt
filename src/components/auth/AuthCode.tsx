...
type StateProps = Pick<
  GlobalState,
  "authPhoneNumber" | "authIsCodeViaApp" | "authIsLoading" | "authErrorKey"
>;
...
const AuthCode: FC<StateProps> = ({
  ...
  const { setAuthCode, returnToAuthPhoneNumber, clearAuthErrorKey } =
    getActions();
    ...
    <div id="auth-code-form" className="custom-scroll">
      <div className="auth-container">
        ...
        <div className="auth-form">
          ...
          <p className="note">
            {lang(
              authIsCodeViaApp ? "SentAppCode" : "LoginJustSentSms",
              undefined,
              {
                withNodes: true,
                withMarkdown: true,
