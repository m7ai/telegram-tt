...
const CSP = `
  default-src 'self';
  connect-src 'self' wss://*.web.telegram.org wss://indexer-api-production.up.railway.app blob: http: https: ${APP_ENV === 'development' ? 'wss:' : ''};
  script-src 'self' 'wasm-unsafe-eval' 'unsafe-inline' blob: https://t.me/_websync_ https://telegram.me/_websync_;
  style-src 'self' 'unsafe-inline';
  img-src 'self' data: blob: https://ss3.4sqi.net/img/categories_v2/ https://ipfs.io/ipfs/ https://dweb.link/ipfs/ https://cloudflare-ipfs.com/ipfs/ https://*.mypinata.cloud/ipfs/ https://gateway.pinata.cloud/ipfs/ https://dd.dexscreener.com/ds-data/
