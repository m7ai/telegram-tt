...
/* harmony import */ var _util_launchMediaWorkers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../util/launchMediaWorkers */ "./src/util/launchMediaWorkers.ts");
...
const workers = (0,_util_launchMediaWorkers__WEBPACK_IMPORTED_MODULE_6__["default"])().map(({
  connector
}) => connector);
...
class RLottie {
  ...
  direction = 1;
  static init(...args) {
    const [, canvas, renderId, params, viewId = (0,_util_generateUniqueId__WEBPACK_IMPORTED_MODULE_5__["default"])(),, onLoad] = args;
  ...
  constructor(tgsUrl, container, renderId, params, viewId = (0,_util_generateUniqueId__WEBPACK_IMPORTED_MODULE_5__["default"])(), customColor, onLoad, onEnded, onLoop) {
    this.tgsUrl = tgsUrl;
  ...
  async setSharedCanvasCoords(viewId, newCoords) {
    ...
    if (isCanvasDirty) {
      ...
      (0,_fasterdom_fasterdom__WEBPACK_IMPORTED_MODULE_7__.requestMeasure)(() => {
  ...
  initRenderer() {
    ...
    if (_config__WEBPACK_IMPORTED_MODULE_2__.IS_BYPASS_AUTH) {
      console.log(">>> SKIPPING RLOTTIE INIT - BYPASS AUTH MODE");
      return;
    }
    this.workerIndex = (0,_util_cycleRestrict__WEBPACK_IMPORTED_MODULE_3__["default"])(_util_launchMediaWorkers__WEBPACK_IMPORTED_MODULE_6__.MAX_WORKERS, ++lastWorkerIndex);
  ...
  destroyRenderer() {
    ...
    if (_config__WEBPACK_IMPORTED_MODULE_2__.IS_BYPASS_AUTH || !workers[this.workerIndex]) {
      return;
    }
    workers[this.workerIndex].request({
  ...
  doPlay() {
    ...
    (0,_util_animation__WEBPACK_IMPORTED_MODULE_0__.animate)(() => {
      ...
      return true;
    }, _fasterdom_fasterdom__WEBPACK_IMPORTED_MODULE_7__.requestMutation);
  }
  getFrame(frameIndex) {
  ...
  cleanupPrevFrame(frameIndex) {
    ...
    const prevFrameIndex = (0,_util_cycleRestrict__WEBPACK_IMPORTED_MODULE_3__["default"])(this.framesCount, frameIndex - 1);
...
//# sourceMappingURL=src_lib_rlottie_RLottie_ts.c75d4422c1dcb50f0423.js.map