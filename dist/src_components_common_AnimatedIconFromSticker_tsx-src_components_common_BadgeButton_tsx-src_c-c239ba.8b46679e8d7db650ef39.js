"use strict";
(self["webpackChunktelegram_t"] = self["webpackChunktelegram_t"] || []).push([["src_components_common_AnimatedIconFromSticker_tsx-src_components_common_BadgeButton_tsx-src_c-c239ba"],{
...
/* harmony import */ var _hooks_useSchedule__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../hooks/useSchedule */ "./src/hooks/useSchedule.tsx");
...
/* harmony import */ var _common_PinMessageModal_async__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../common/PinMessageModal.async */ "./src/components/common/PinMessageModal.async.tsx");
...
/* harmony import */ var _MessageContextMenu__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./MessageContextMenu */ "./src/components/middle/message/MessageContextMenu.tsx");
...
const ContextMenuContainer = ({
  ...
  const [requestCalendar, calendar] = (0,_hooks_useSchedule__WEBPACK_IMPORTED_MODULE_15__["default"])(canScheduleUntilOnline, onClose, message.date);
  ...
  const closeMenu = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    setIsMenuOpen(false);
    onClose();
  });
  const handleDelete = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    setIsMenuOpen(false);
    closeMenu();
  ...
  const closePinModal = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    setIsPinModalOpen(false);
    onClose();
  });
  const handleReply = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
  ...
  const handleOpenThread = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    openThread({
      chatId: message.chatId,
      threadId: message.id
    });
  ...
  const handleEdit = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
  ...
  const handleAppendTodoList = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
  ...
  const handlePin = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    setIsMenuOpen(false);
    setIsPinModalOpen(true);
  });
  const handleUnpin = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    pinMessage({
      chatId: message.chatId,
      messageId: message.id,
      isUnpin: true
  ...
  const handleForward = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    closeMenu();
    if (album?.messages) {
  ...
  const handleFaveSticker = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    closeMenu();
    faveSticker({
      sticker: message.content.sticker
    });
  });
  const handleUnfaveSticker = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    closeMenu();
    unfaveSticker({
      sticker: message.content.sticker
    });
  });
  const handleCancelVote = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    closeMenu();
    cancelPollVote({
      chatId: message.chatId,
      messageId: message.id
  ...
  const handlePollClose = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    closeMenu();
    closePoll({
      chatId: message.chatId,
      messageId: message.id
  ...
  const handleSelectMessage = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
  ...
  const handleScheduledMessageSend = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    sendScheduledMessages({
      chatId: message.chatId,
      id: message.id
    });
  ...
  const handleRescheduleMessage = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(scheduledAt => {
    rescheduleMessage({
      chatId: message.chatId,
      messageId: message.id,
      scheduledAt
  ...
  const handleOpenCalendar = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    setIsMenuOpen(false);
    requestCalendar(handleRescheduleMessage);
  });
  const handleOpenSeenByModal = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    closeMenu();
    openSeenByModal({
      chatId: message.chatId,
      messageId: message.id
  ...
  const handleOpenReactorListModal = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    closeMenu();
    openReactorListModal({
      chatId: message.chatId,
      messageId: message.id
  ...
  const handleCopyMessages = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(messageIds => {
    copyMessagesByIds({
      messageIds
    });
    closeMenu();
  ...
  const handleCopyNumber = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    (0,_util_clipboard__WEBPACK_IMPORTED_MODULE_7__.copyTextToClipboard)(message.content.contact.phoneNumber);
    closeMenu();
  });
  const handleDownloadClick = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
  ...
  const handleSaveGif = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
  ...
  const handleToggleReaction = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(reaction => {
  ...
  const handleSendPaidReaction = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    addLocalPaidReaction({
      chatId: message.chatId,
      messageId: message.id,
      count: 1
  ...
  const handlePaidReactionModalOpen = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    openPaidReactionModal({
      chatId: message.chatId,
      messageId: message.id
    });
  ...
  const handleReactionPickerOpen = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(position => {
    openMessageReactionPicker({
      chatId: message.chatId,
      messageId: message.id,
      position
  ...
  const handleTranslate = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    requestMessageTranslation({
      chatId: message.chatId,
      id: message.id
    });
  ...
  const handleShowOriginal = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    showOriginalMessage({
      chatId: message.chatId,
      id: message.id
    });
  ...
  const handleSelectLanguage = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    openChatLanguageModal({
      chatId: message.chatId,
      messageId: message.id
    });
  ...
  const handleReport = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    if (!chat) return;
    setIsMenuOpen(false);
    onClose();
    reportMessages({
  ...
  return (0,_teact_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsxs)("div", {
    ...
    children: [(0,_teact_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_MessageContextMenu__WEBPACK_IMPORTED_MODULE_19__["default"], {
      ...
      canGift: canGift
    }), (0,_teact_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_common_PinMessageModal_async__WEBPACK_IMPORTED_MODULE_17__["default"], {
      isOpen: isPinModalOpen,
      messageId: message.id,
      chatId: message.chatId,
      onClose: closePinModal
    }), (0,_teact_jsx_runtime__WEBPACK_IMPORTED_MODULE_20__.jsx)(_ui_ConfirmDialog__WEBPACK_IMPORTED_MODULE_18__["default"], {
...
//# sourceMappingURL=src_components_common_AnimatedIconFromSticker_tsx-src_components_common_BadgeButton_tsx-src_c-c239ba.8b46679e8d7db650ef39.js.map